...
(function (global) {
  ...
  function turkceSayiSozu(sozcuk) {
    ...
    // Kesir ifadelerinde pay/payda sözcükleri ek alabilir:
    // "ikisi", "üçü", "dördü", "beşi", "altısı" vb.
    // Önce yalın biçimi dene; ardından yalnızca Türkçe iyelik/hal
    // eklerinden birini kaldırarak aynı sayı sözcüğünü tanı.
